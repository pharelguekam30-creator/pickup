            ...
            @foreach($plans->where('type', $type) as $plan)
                <div style="background:#fff;border-radius:1rem;padding:1.5rem;box-shadow:0 2px 8px #00000011;display:flex;flex-direction:column;">
                    ...
                    <div style="display:flex;justify-content:space-between;align-items:center;margin-top:.5rem;">
                        <span style="font-size:1.3rem;font-weight:bold;color:#059669;">{{ number_format($plan->price_per_month, 0, ',', ' ') }} FCFA<small style="font-size:.8rem;color:#6b7280;font-weight:400;">/mois</small></span>
