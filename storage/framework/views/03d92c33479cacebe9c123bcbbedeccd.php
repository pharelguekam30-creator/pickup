...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - Pickup</title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/logo.png.jpeg')); ?>">
    ...
    <style>
        ...
        * {
        ...
        .main-background {
            background: url('<?php echo e(asset("images/fond.jpeg")); ?>') no-repeat center center / cover;
            position: relative;
            min-height: 80vh;
            display: flex;
...
<body>
    ...
    <header>
        <div class="header-container">
            <div class="logo">
                <img src="<?php echo e(asset('images/logo.png.jpeg')); ?>" alt="Pickup logo">
                Pickup
            </div>
            <nav>
                <a href="<?php echo e(route('home')); ?>">Accueil</a>
                <a href="<?php echo e(route('services.index')); ?>">Services</a>
                <a href="<?php echo e(route('map.index')); ?>">Carte</a>

                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->role == 'menagere'): ?>
                        <a href="<?php echo e(route('avis.index')); ?>">Avis</a>
                        <a href="<?php echo e(route('menagere.dashboard')); ?>">Dashboard</a>
                    <?php elseif(auth()->user()->role == 'vidangeur'): ?>
                        <a href="<?php echo e(route('vidangeur.dashboard')); ?>">Dashboard</a>
                    <?php elseif(auth()->user()->role == 'admin'): ?>
                        <a href="<?php echo e(route('dashboard')); ?>">Dashboard</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('payments.index')); ?>">Portefeuille</a>
                    <a href="<?php echo e(route('profile')); ?>">Mon Profil</a>
    ...
    <!-- MAIN CONTENT -->
    <main>
        <?php if (! empty(trim($__env->yieldContent('main-background')))): ?>
        ...
        <?php else: ?>
            <div style="display:flex;gap:1.5rem;max-width:1200px;margin:0 auto;padding:0 20px;">
                ...
                <?php endif; ?>
                <?php if (! empty(trim($__env->yieldContent('fullwidth')))): ?>
    ...
    <!-- FOOTER -->
    <footer>
        <p>&copy; <?php echo e(date('Y')); ?> Pickup. Tous droits réservés.</p>
    </footer>
</body>
</html>
<?php /**PATH C:\Users\pharel\Desktop\cours\API\moi\PICKUP\resources\views/layouts/app.blade.php ENDPATH**/ ?>